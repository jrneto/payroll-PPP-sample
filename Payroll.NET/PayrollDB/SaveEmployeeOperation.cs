...
namespace PayrollDB
{
	public class SaveEmployeeOperation
	{
		...
		private void PrepareToSaveEmployee(Employee employee)
		{
			...
			this.insertEmployeeCommand.Parameters.AddWithValue("@EmpId", employee.EmpId);
			this.insertEmployeeCommand.Parameters.AddWithValue("@Name", employee.Name);
			this.insertEmployeeCommand.Parameters.AddWithValue("@Address", employee.Address);
			this.insertEmployeeCommand.Parameters.AddWithValue("@ScheduleType", ScheduleCode(employee.Schedule));
			this.insertEmployeeCommand.Parameters.AddWithValue("@PaymentMethodType", methodCode);
			this.insertEmployeeCommand.Parameters.AddWithValue("@PaymentClassificationType", classificationCode);
		}
